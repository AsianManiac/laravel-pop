...
export const countries: Country[] = [
  ...
  { name: "Netherlands (Kingdom of the)", code2: "NL", code3: "NLD" },
  ...
  { name: "Syrian Arab Republic (the)", code2: "SY", code3: "SYR" },
  { name: "Taiwan (Province of China)", code2: "TW", code3: "TWN" },
  { name: "Tajikistan", code2: "TJ", code3: "TJK" },
  { name: "Tanzania, the United Republic of", code2: "TZ", code3: "TZA" },
  ...
  { name: "Türkiye", code2: "TR", code3: "TUR" },
